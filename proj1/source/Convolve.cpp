...
// new filters:
CFloatImage ConvolveKernel_Gaussian_5x5_1;
CFloatImage ConvolveKernel_Gaussian_5x5_1X;
CFloatImage ConvolveKernel_Gaussian_5x5_1Y;
CFloatImage ConvolveKernel_Gaussian_5x5_2;
...
KernelInit::KernelInit()
{
    ...
    //Gaussion Filter window size 5x5, sigma = 1
    static float k_g_5x5_1[25] = {0.0030, 0.0133, 0.0219, 0.0133, 0.0030,
                                  0.0133, 0.0596, 0.0983, 0.0596, 0.0133,
                                  0.0219, 0.0983, 0.1621, 0.0983, 0.0219,
                                  0.0133, 0.0596, 0.0983, 0.0596, 0.0133,
                                  0.0030, 0.0133, 0.0219, 0.0133, 0.0030 };

    static float k_g_5x5_2[25] = {0.0232, 0.0338, 0.0383, 0.0338, 0.0232,
    ...
    ConvolveKernel_Gaussian_5x5_2.ReAllocate(CShape(5, 5, 1), k_g_5x5_2, false, 5);
    ConvolveKernel_Gaussian_5x5_2.origin[0] = 2;
    ConvolveKernel_Gaussian_5x5_2.origin[1] = 2;

    ConvolveKernel_Gaussian_5x5_1.ReAllocate(CShape(5, 5, 1), k_g_5x5_1, false, 5);
    ConvolveKernel_Gaussian_5x5_1.origin[0] = 2;
    ConvolveKernel_Gaussian_5x5_1.origin[1] = 2;
    ...
    /* Gaussian filters */ 
    static float k_g_5x5_1X[25] = {0.0030, 0.0133, 0, 0.0133, 0.0030,
                                  0.0133, 0.0596, 0, 0.0596, 0.0133,
                                  0.0219, 0.0983, 0, 0.0983, 0.0219,
                                  0.0133, 0.0596, 0, 0.0596, 0.0133,
                                  0.0030, 0.0133, 0, 0.0133, 0.0030 };

    static float k_g_5x5_1Y[25] = {0.0030, 0.0133, 0.0219, 0.0133, 0.0030,
                                  0.0133, 0.0596, 0.0983, 0.0596, 0.0133,
                                  0, 0, 0, 0, 0,
                                  0.0133, 0.0596, 0.0983, 0.0596, 0.0133,
                                  0.0030, 0.0133, 0.0219, 0.0133, 0.0030 };
    ...
    ConvolveKernel_Gaussian_5x5_1X.ReAllocate(CShape(5, 5, 1), k_g_5x5_1X, false, 5);
    ConvolveKernel_Gaussian_5x5_1X.origin[0] = 2;
    ConvolveKernel_Gaussian_5x5_1X.origin[1] = 2;
    ConvolveKernel_Gaussian_5x5_1Y.ReAllocate(CShape(5, 5, 1), k_g_5x5_1Y, false, 5);
    ConvolveKernel_Gaussian_5x5_1Y.origin[0] = 2;
    ConvolveKernel_Gaussian_5x5_1Y.origin[1] = 2;
