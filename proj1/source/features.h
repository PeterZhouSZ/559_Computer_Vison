...
void computeOrientation(CFloatImage &image, CFloatImage &orientation);
...
void ComputeCircularDescriptors(CFloatImage &grayImage, FeatureSet &features);

void ComputeHarrisFeatures_MOPS(CFloatImage &image, FeatureSet &features);

void ComputeHarrisFeatures_Circular(CFloatImage &image, FeatureSet &features);
